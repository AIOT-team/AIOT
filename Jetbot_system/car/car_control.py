...
class Car:
    ...
    #
    # def get_dc_speed(self):
    #     dc_speed = self.__dcMotor_speed
    #     return dc_speed
    #
    # def get_servo_angle(self):
    #     servo_angle = self.__handle_angle
    #     return servo_angle
    ...
    #     self.__motor_control.throttle_gain = 0.65
    ...
    #     # print("backward")
    #     # self.__motor_control.throttle = 0
    #     self.__motor_control.throttle_gain = 0.56
    #     self.__motor_control.throttle = -1
    #
    # def stop(self):
    #     # print("stop")
    ...
    def backward(self, target):
        self.__motor_control.throttle = 0
        self.__motor_control.throttle_gain = target / 100
        self.__motor_control.throttle = 1
        self.__dcMotor_speed = target
